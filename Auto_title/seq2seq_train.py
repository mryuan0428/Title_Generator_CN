...
s1 = u'近日，南京国际美术展组委会在北京宣布第二届南京国际美术展正式启动，将面向全球艺术家征集美术展作品。据了解，在本次美术展中，毕加索的20幅绘画将会亮相“国际艺术大师展”板块。据南京国际美术展组委会秘书长黄炳良介绍，展览共分为四大板块：“国际艺术大师展”、“国际当代艺术主题展”、“征集展”和“中国传统水墨的延伸”。其中，在“国际艺术大师展”部分，将会呈现多位国际艺术大师的作品，其中包括20幅毕加索作品，罗丹的雕塑、高更的风景画、毕沙罗的人物画、夏加尔的《马戏团》、梵高《拿烟斗的老人》等，总共将会呈现50余件。'
...
class Evaluate(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if logs['loss'] <= self.lowest:
            ...
            model.save_weights(sys.path[0] + '/best_model.weights')
